...
class Utils
{
	 ...
	 */
	public function getInsult($name) {
		$client = new Guzzle\Http\Client();

		$url = "http://foaas.herokuapp.com/" . $this->pickInsult() . "/" . $name;
	 ...
	 */
	public function getName($year, $month, $day) {
		if ($day < 1 || $day > 31 || $month < 1 || $month > 12 || $year < 4) {
			return null;
		}
		$client = new Guzzle\Http\Client();
